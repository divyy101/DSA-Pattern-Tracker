    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6 animate-fade-slide-up">
      ...
      <div className="bg-[#0e1626] border border-slate-800 p-6 sm:p-8 space-y-4 shadow-md">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-slate-800 pb-4">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 text-xs font-bold bg-cyan-950 text-cyan-400 border border-cyan-500/30 mb-2">
          ...
          <div className="flex items-center gap-4 bg-[#080d1a] border border-slate-800 p-3 text-xs sm:text-sm font-bold shrink-0">
            <div>
              <span className="text-[0.7rem] text-slate-500 uppercase block">Active Streak</span>
            ...
            <div className="pl-4 border-l border-slate-800">
              <span className="text-[0.7rem] text-slate-500 uppercase block">Overall Completion</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#0e1626] border border-slate-800 p-6 space-y-4 shadow-md">
          <div className="flex items-center justify-between border-b border-slate-800 pb-3">
            <div className="flex items-center gap-2 text-white">
              ...
              <h3 className="text-base font-bold">Weekly Problem Velocity</h3>
            </div>
          ...
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={weeklyData}>
                ...
                <Tooltip
                  contentStyle={{ backgroundColor: "#080d1a", borderColor: "#334155", borderRadius: "0px", fontSize: "12px", color: "#F8FAFC" }}
                />
        ...
        <div className="bg-[#0e1626] border border-slate-800 p-6 space-y-4 shadow-md">
          <div className="flex items-center gap-2 border-b border-slate-800 pb-3 text-white">
            ...
            <h3 className="text-base font-bold">Difficulty Split</h3>
          </div>
      ...
      <div className="bg-[#0e1626] border border-slate-800 p-6 space-y-4 shadow-md">
        <div className="flex items-center gap-2 border-b border-slate-800 pb-3 text-white">
          ...
          <h3 className="text-base font-bold">Pattern Mastery Breakdown</h3>
        </div>
